...
public class FollowingTests : MonoBehaviour {
    ...
    public UnityEngine.Transform followTrans;

    public UnityEngine.Transform cube1;
    private float cube1VelocityX;

    public UnityEngine.Transform cube2;
    private float cube2VelocityX;

    public UnityEngine.Transform cube3;
    private float cube3VelocityX;

    public UnityEngine.Transform cube4;
    private float cube4VelocityX;

    public UnityEngine.Transform cube5;
    private float cube5VelocityX;

    public UnityEngine.Transform cube6;
    private Vector3 cube6Velocity;

    public UnityEngine.Transform fly1;
