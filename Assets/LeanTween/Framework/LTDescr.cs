...
public class LTDescr
{
    ...
    // Convenience Getters
    public UnityEngine.Transform toTrans{
        get{
    ...
    public LTDescr setTarget(UnityEngine.Transform trans)
    {
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
	...
	private static void alphaRecursive(UnityEngine.Transform transform, float val, bool useRecursion = true){
	...
	private static void colorRecursive(UnityEngine.Transform transform, Color toColor, bool useRecursion = true ){
	...
	private static void alphaRecursiveSprite(UnityEngine.Transform transform, float val ){
	...
	private static void colorRecursiveSprite(UnityEngine.Transform transform, Color toColor ){
		if(transform.childCount>0){
			foreach (UnityEngine.Transform child in transform) {
	...
	private static void textAlphaChildrenRecursive(UnityEngine.Transform trans, float val, bool useRecursion = true ){
	...
	private static void textAlphaRecursive(UnityEngine.Transform trans, float val, bool useRecursion = true ){
	...
	private static void textColorRecursive(UnityEngine.Transform trans, Color toColor ){
