...
public static class LeanTweenExt
{
    ...
    public static LTDescr LeanMove(this UnityEngine.Transform transform, Vector3 to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanMove(this UnityEngine.Transform transform, Vector2 to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    //LeanTween.move
    public static LTDescr LeanMove(this GameObject gameObject, Vector3[] to, float time) { return LeanTween.move(gameObject, to, time); }
    ...
    public static LTDescr LeanMove(this UnityEngine.Transform transform, Vector3[] to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    public static LTDescr LeanMove(this UnityEngine.Transform transform, LTBezierPath to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    public static LTDescr LeanMove(this UnityEngine.Transform transform, LTSpline to, float time) { return LeanTween.move(transform.gameObject, to, time); }
    //LeanTween.moveLocal
    ...
    public static LTDescr LeanMoveLocal(this UnityEngine.Transform transform, Vector3 to, float time) { return LeanTween.moveLocal(transform.gameObject, to, time); }
    public static LTDescr LeanMoveLocal(this UnityEngine.Transform transform, LTBezierPath to, float time) { return LeanTween.moveLocal(transform.gameObject, to, time); }
    public static LTDescr LeanMoveLocal(this UnityEngine.Transform transform, LTSpline to, float time) { return LeanTween.moveLocal(transform.gameObject, to, time); }
    //LeanTween.moveLocal
    ...
    public static LTDescr LeanMoveLocalX(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveLocalX(transform.gameObject, to, time); }
    public static LTDescr LeanMoveLocalY(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveLocalY(transform.gameObject, to, time); }
    public static LTDescr LeanMoveLocalZ(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveLocalZ(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanMoveSpline(this UnityEngine.Transform transform, Vector3[] to, float time) { return LeanTween.moveSpline(transform.gameObject, to, time); }
    public static LTDescr LeanMoveSpline(this UnityEngine.Transform transform, LTSpline to, float time) { return LeanTween.moveSpline(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanMoveSplineLocal(this UnityEngine.Transform transform, Vector3[] to, float time) { return LeanTween.moveSplineLocal(transform.gameObject, to, time); }
    //LeanTween.moveX
    public static LTDescr LeanMoveX(this GameObject gameObject, float to, float time) { return LeanTween.moveX(gameObject, to, time); }
    public static LTDescr LeanMoveX(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveX(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanMoveY(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveY(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanMoveZ(this UnityEngine.Transform transform, float to, float time) { return LeanTween.moveZ(transform.gameObject, to, time); }
    ...
    public static LTDescr LeanRotate(this UnityEngine.Transform transform, Vector3 to, float time) { return LeanTween.rotate(transform.gameObject, to, time); }
    //LeanTween.rotate
    ...
    public static LTDescr LeanRotateAround(this UnityEngine.Transform transform, Vector3 axis, float add, float time) { return LeanTween.rotateAround(transform.gameObject, axis, add, time); }
    ...
    public static LTDescr LeanRotateAroundLocal(this UnityEngine.Transform transform, Vector3 axis, float add, float time) { return LeanTween.rotateAroundLocal(transform.gameObject, axis, add, time); }
    //LeanTween.rotateAround (RectTransform)
    ...
    public static LTDescr LeanRotateX(this UnityEngine.Transform transform, float to, float time) { return LeanTween.rotateX(transform.gameObject, to, time); }
    //LeanTween.rotateY
    ...
    public static LTDescr LeanRotateY(this UnityEngine.Transform transform, float to, float time) { return LeanTween.rotateY(transform.gameObject, to, time); }
    //LeanTween.rotateZ
    ...
    public static LTDescr LeanRotateZ(this UnityEngine.Transform transform, float to, float time) { return LeanTween.rotateZ(transform.gameObject, to, time); }
    //LeanTween.scale
    ...
    public static LTDescr LeanScale(this UnityEngine.Transform transform, Vector3 to, float time) { return LeanTween.scale(transform.gameObject, to, time); }
    //LeanTween.scale (GUI)
    ...
    public static LTDescr LeanScaleX(this UnityEngine.Transform transform, float to, float time) { return LeanTween.scaleX(transform.gameObject, to, time); }
    //LeanTween.scaleY
    ...
    public static LTDescr LeanScaleY(this UnityEngine.Transform transform, float to, float time) { return LeanTween.scaleY(transform.gameObject, to, time); }
    //LeanTween.scaleZ
    ...
    public static LTDescr LeanScaleZ(this UnityEngine.Transform transform, float to, float time) { return LeanTween.scaleZ(transform.gameObject, to, time); }
    //LeanTween.sequence
    ...
    public static void LeanSetPosX(this UnityEngine.Transform transform, float val){
        transform.position = new Vector3(val, transform.position.y, transform.position.z);
    }
    public static void LeanSetPosY(this UnityEngine.Transform transform, float val) {
        transform.position = new Vector3(transform.position.x, val, transform.position.z);
    }
    public static void LeanSetPosZ(this UnityEngine.Transform transform, float val) {
        transform.position = new Vector3(transform.position.x, transform.position.y, val);
    }

    public static void LeanSetLocalPosX(this UnityEngine.Transform transform, float val)
    {
        transform.localPosition = new Vector3(val, transform.localPosition.y, transform.localPosition.z);
    }
    public static void LeanSetLocalPosY(this UnityEngine.Transform transform, float val)
    {
        transform.localPosition = new Vector3(transform.localPosition.x, val, transform.localPosition.z);
    }
    public static void LeanSetLocalPosZ(this UnityEngine.Transform transform, float val)
    {
        transform.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y, val);
    }

    public static Color LeanColor(this UnityEngine.Transform transform)
    {
